  ...
  services = {
    ...
    rss = {
      ...
      environment = {
        ...
        OAUTH2_OIDC_DISCOVERY_ENDPOINT     = "https://id.replo.de"
      ...
      labels = {
        ...
        "pangolin.public-resources.rss.auth.auto-login-idp"             = "2"
